...
const DisabilityMedicalLetter = () => {
  return (
    <section>
      <div className="fluid-container pt-12 pb-16">
            ...
            <div className="lg:col-span-3">
              ...
              <div className="hidden sm:grid grid-cols-4 gap-2 w-[90%]">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="relative aspect-4/3 w-full overflow-hidden hover:cursor-pointer transition"
                  >
                    <Image
            ...
            <div className="lg:col-span-2 mt-6 md:-ml-8 ">
              ...
              <div className="flex items-center gap-4 mb-4">
                <div className="flex items-center border border-gray-300 py-1 px-4 overflow-hidden">
                  <button className="p-3 text-gray hover:bg-gray-100 transition"><Minus className="w-4 h-4" /></button>
                  <span className="px-4 text-lg font-semibold">1</span>
                  <button className="p-3 text-gray hover:bg-gray-100 transition"><Plus className="w-4 h-4" /></button>
                </div>
                <button className="flex-1 bg-white text-navygreen font-bold border border-navygreen py-4 px-4 text-[12px]
                    ...
                    hover:bg-navygreen hover:text-white transition rounded">
                    ADD TO CART
                </button>
              ...
              <p className="text-sm text-gray-500 mb-6">
                <CheckCircle className="w-4 h-4 inline-block mr-1 align-sub text-navygreen" /> 1 hour average turnaround & delivered to your inbox
              </p>
