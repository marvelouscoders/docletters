  ...
  return (
    <section className="relative w-full overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        {/* ✅ Content Section */}
        <div className="theme-container flex flex-col md:flex-row items-start px-6 py-[12%] md:py-[10%] relative z-10">
          <div className="md:w-[40%] w-full bg-white/90 shadow-xl border-8 border-skyblue px-8 py-10 backdrop-blur-sm text-center md:text-left -mt-8">
            <h1>
          ...
          <div className="hidden md:block absolute bottom-0 left-0 w-full h-12 bg-navygreen z-20 pointer-events-none">
